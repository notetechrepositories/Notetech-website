                ...
                <>
                  {item.href ? (
                    <NavLink
                      ...
                      className="inline-flex items-center gap-1.5 whitespace-nowrap px-2 py-2 text-[0.72rem] font-semibold leading-none tracking-[0.06em] text-[#0b0f18] uppercase hover:text-primary"
                    >
                      <span className="leading-tight">{item.label}</span>
                      <span
                        className="text-[#0b0f18] group-hover:text-primary/80 shrink-0 transition-colors"
                        aria-hidden
                      >
                        <svg
                    ...
                    <button
                      type="button"
                      className="motion-interactive inline-flex items-center gap-1.5 whitespace-nowrap px-2 py-2 text-[0.72rem] font-semibold leading-none tracking-[0.06em] text-[#0b0f18] uppercase outline-none hover:text-primary focus-visible:ring-2 focus-visible:ring-primary/35 focus-visible:ring-offset-2"
                      aria-haspopup="true"
                    >
                      <span className="leading-tight">{item.label}</span>
